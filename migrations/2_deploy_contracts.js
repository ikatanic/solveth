        ...
        return deployer.deploy(TravellingSalesman).then(function () {
            return deployer.deploy(Main).then(function () {
                return Main.deployed().then(function (contract) {
                    return contract.newProblem(Factorization.address, {
                        from: web3.eth.accounts[0],
                        gas: 200000
                    }).then(function (result) {
                        return contract.newProblem(TravellingSalesman.address, {
                            from: web3.eth.accounts[0],
                            gas: 200000
                        }).then(function (result) {
                            return contract.newInstance(0, [30], {
                                from: web3.eth.accounts[0],
                                gas: 200000,
                                value: 1000000000
                            })
                        }).then(function (result) {
                            return contract.newInstance(0, [58], {
                                from: web3.eth.accounts[0],
                                gas: 200000,
                                value: 2000000000
                            })
                        }).then(function (result) {
                            return contract.newInstance(1, [100], {
                                from: web3.eth.accounts[0],
                                gas: 200000,
                                value: 10000000000
                            })})
